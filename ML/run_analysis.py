#!/usr/bin/env python3
"""
Script to run the EAE TCR-GEX analysis
"""
...
def plot_confusion(Y_test, class_pred, s, title, output_dir):
...
def main():
    print("Starting EAE TCR-GEX Analysis...")
    ...
    for ind1 in Bool_list:
        if ind1:
            M_sub1 = df_all_features[df_all_features['clone_id_size'] > 1]
        ...
        for ind2 in Cell_types:
            ...
            # Test split: mouse_id '5_3' and '5_4'
            test_id = ['5_3', '5_4']
            ...
            plot_confusion(Y_test, class_pred, s, mouse_id, OUTPUT_DIR)
            plot_ROC(Y_test, test_pred, mouse_id, OUTPUT_DIR)
